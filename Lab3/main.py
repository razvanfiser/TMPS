...
# Lab 3
# In the main class we only operate with CareTaker and Originator (in our case Soldier) objects

# we make the soldier move a bunch and record the states after each movement in the caretaker
